    ...
    public function voucher_add() {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $data = [
                ...
                'discount_amount' => clean_price($_POST['discount_amount']),
                'max_discount' => !empty($_POST['max_discount']) ? clean_price($_POST['max_discount']) : null,
                'min_order_value' => !empty($_POST['min_order_value']) ? clean_price($_POST['min_order_value']) : 0,
