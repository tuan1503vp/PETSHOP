...
class Review {
    ...
    public function getReviewsByProductId($product_id) {
        $this->db->query("SELECT r.*, u.fullname as user_name, u.avatar as user_avatar FROM reviews r JOIN users u ON r.user_id = u.id WHERE r.product_id = :product_id ORDER BY r.created_at DESC");
